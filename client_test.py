...
def perseo_test():
    ...
    # #Test
    # client.subscribe_attributes_change("LDR001", ["luminosity"], "http://192.168.1.102:1234/")
    ...
    # client.send_observation("UL_LDR", {'l': 100}, protocol='http')
    # client.send_observation("UL_LDR", {'l': 90}, protocol='http')
    client.send_observation("UL_LDR", {'l': 120}, protocol='http')
    # client.send_observation("UL_LDR", {'l': 255}, protocol='http')
...
def comet_test():
    ...
    client.send_observation("UL_LDR", {'l': 80}, protocol='http')
    client.send_observation("UL_LDR", {'l': 100}, protocol='mqtt')
    client.send_observation("UL_LDR", {'l': 90}, protocol='mqtt')
